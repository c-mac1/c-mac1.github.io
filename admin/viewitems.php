...
$(function () {
  $('[data-toggle="popover"]').popover()
	...
	<div class="container">
		...
		<div class="row pad2">
    		<div class="col-sm"><h1 class="text-center">View Posted Items <i class="fas fa-tshirt"></i></h1>
    		</div>
    	</div>
	...
	<?php
		...
		while ($row = $result->fetch_assoc()){		
			...
			<div class ='row'>
				...
				<img src='productimgstorage/$prodimage' alt='$desc Image' class='img-thumbnail'>
				</div>
				
				<div class ='col prod pad2'>
					
					<p><h3>Description: $desc</h3></p>
					<p><b>Information:</b>$info</p>
					<p><b>Price:</b>£$price</p>
					
					<a href='editrow.php?editid=$rowid' class='btn btn-primary'>Edit Items For Sale</a>
