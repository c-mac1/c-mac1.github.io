...
session_start();
	...
	//userid
	$getid = $conn->real_escape_string($_GET['product']);
...
<link rel="stylesheet" href ="../ui.css">
	...
	<div class="container"> 
		...
		<div class="row pad2">
    		<div class="col-sm"><h1 class="text-center">Seller Account</h1>
    		</div>
    	</div>
	...
	<?php
			...
			<div class ='row'>
				...
				<div class ='col prod pad2'>
					<p><h3>Name: $username</h3></p>
					<p><b>Email: </b>$email</p>
					<p><b>School: </b>$school</p>
					<p><a href ='$smedia'<i class='fab fa-facebook'></a></p>
				
			<form method ='POST' action ='sellerprofileprocess.php'>
			
			<input type='hidden' value ='$userID' name='myuserid'>
			<input type='hidden' value ='$getid' name='prodid'>
			
						
			<button type='submit' class='btn btn-primary' name='ReviewSeller'>Review Seller</button>
			</form>
				</div>
			</div>
