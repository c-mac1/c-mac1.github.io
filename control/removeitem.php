...
if (!isset($_SESSION['40146593_admin'])){
	...
	$delete = "DELETE FROM WD_Products WHERE id = '$deleteid'";
...
<link rel="stylesheet" href ="../ui.css">
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	...
	<div class="container">
		...
		<div class='jumbotron'>
  			<h1 class='display-4'>You have deleted this Product! <i class='fas fa-edit'></i></h1>
  			<hr class='my-4'>
  			<p class='lead'>Return to the View Users page to make more changes</p>
  			<p class='lead'>
    		<a class='btn btn-primary btn-lg' href='viewusers.php' role='button'>View Users</a>
			</p>
		</div>
