...
//}
	...
	$produserid = $conn->real_escape_string($_GET['produserid']);
	
	//$removeitem = "DELETE FROM WD_USERS WHERE id = '$deleteid'";
...
$(function () {
  $('[data-toggle="popover"]').popover()
	...
	<div class="container">
		...
		<div class="row pad2">
    		<div class="col-sm"><h1 class="text-center">User Products <i class="fas fa-tshirt"></i></h1>
    		</div>
    	</div>
	...
	<?php
		...
		while ($row = $result->fetch_assoc()){		
			...
			<div class ='row'>
				...
				<img src='../admin/productimgstorage/$prodimage' alt='$desc Image' class='img-thumbnail'>
				</div>
				
				<div class ='col prod pad2'>
					
					<p><b><h3>Description:</b></h3> $desc</p>
					<p><b>Price:</b>£$price</p>
					
					<form action='removeitem.php' method='POST' enctype='multipart/form-data'>
					<input type='hidden' value ='$rowid' name='deleteid'>
					<button type='submit' class='btn btn-danger float-right mar1' data-container='body' data-toggle='popover' data-placement='right' data-content='Delete Item' value='deleteprod' name ='delete' formaction='removeitem.php'>
