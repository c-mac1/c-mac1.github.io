	...
	<div class ="row pad2">
		<div class ="col">
			<h1 class="text-center">
  			Welcome to Elmtree GAA Swap Shop
  			</h1>
		...
		<div class ="row pad1">
		<div class ="col">
			<h1 class="text-center students text-primary">
  			Students Login/Register to view the #1 GAA Selling Site
  			</h1>
  		...
  		<div class="card text-center" style="width: 18rem;">
  			...
  			<div class="card-body">
    			...
    			<a href="admin/selling.php"><button type="btn btn-primary" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Sell unwanted items">Sell
    			</button></a>
  			</div>
  		</div>
  		</div>
  		...
  		<div class="card text-center" style="width: 18rem;">
  			...
  			<div class="card-body">
    			...
    			<a href="admin/account.php"><button type="btn btn-primary" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Edit account details ">View account
    			</button></a>
  			</div>
  		</div>
  		</div>
